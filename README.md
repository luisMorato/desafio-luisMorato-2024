...
[X] 6- Quando há mais de uma espécie no mesmo recinto, é preciso considerar 1 espaço extra ocupado
[X] 7- Não é possível separar os lotes de animais nem trocar os animais que já existem de recinto (eles são muito apegados!).
...
[X] 6- Caso não haja recinto possível, apresentar erro "Não há recinto viável"
